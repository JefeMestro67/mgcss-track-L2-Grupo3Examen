...
class TecnicoTest {
    ...
    void no_debe_permitir_incrementar_carga_si_llega_al_limite() {
        ...
        tecnicoSaturado.setNombre("Carlos");
    ...
    void no_debe_permitir_incrementar_carga_si_esta_inactivo() {
        ...
        tecnicoInactivo.setId(1L);
        tecnicoInactivo.setNombre("Carlos");
        tecnicoInactivo.setActivo(false);
        tecnicoInactivo.setCargaTrabajo(0);
    ...
    void no_debe_permitir_finalizar_tarea_si_la_carga_ya_es_cero() {
        Tecnico tecnicoSinTareas = new Tecnico();
        tecnicoSinTareas.setId(1L);
        tecnicoSinTareas.setNombre("Carlos");
        tecnicoSinTareas.setActivo(true);
        tecnicoSinTareas.setCargaTrabajo(0);
